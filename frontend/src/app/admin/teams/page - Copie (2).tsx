...
*/
// IMPORTANT : On ne déclenche le chargement des données que si l'auth est prête
  useEffect(() => {
    if (!authLoading && currentUser) {
      loadUsers();
    }
  }, [authLoading, currentUser]); // Ajoutez ces dépendances
  ...
  // Empêcher le rendu si l'auth est en cours
  if (authLoading) {
    return (
  ...
  // Si pas d'utilisateur après le chargement, on ne rend rien (le hook gérera la redirection)
